        ...
        snapshotFlow {
            ...
            .filter { (total, last) ->
                when (selectedSectionState.value) {
                    ...
                    SpaceSection.LIVE_RECORD -> liveRecordsState.value.canLoadMore
                } &&
                        total > 0 &&
        ...
        if (header != null) {
            LazyColumn(
                ...
                spaceArchiveSection(
                    ...
                    liveRecords = state.liveRecords,
                    contributeTabs = state.contributeTabs,
                    selectedContributeIndex = state.selectedContributeIndex,
                    contributeVideos = state.contributeVideos,
                    contributeLoading = state.contributeLoading,
                    contributeMessage = state.contributeMessage,
                    section = state.selectedSection,
                    onOpenVideo = onOpenVideo,
                    onSelectOrder = viewModel::selectOrder,
                    onSelectSection = viewModel::selectSection,
                    onSelectContribute = viewModel::selectContribute,
