...
- [bilibili-API-collect](https://github.com/SocialSisterYi/bilibili-API-collect)
  - B 站公开 API、协议与直播回放等接口整理的重要参考。
- [PiliPlus](https://github.com/bggRGjQaUbCoE/PiliPlus)
  - 第三方 B 站客户端的交互与功能设计参考。
...
- [DanmakuFlameMaster](https://github.com/naaammme/DanmakuFlameMaster)
  - 弹幕渲染方案参考与依赖。
- [BiliLiveRecorder](https://github.com/InJeCTrL/BiliLiveRecorder)
  - 直播录制与回放相关字段、场景的参考。
- 以及所有公开整理 B 站接口和 Android 客户端实现思路的开发者。

## 参与开发

- 欢迎提交 Issue 和 Pull Request。
- 提交前建议先确认问题可复现，并尽量附上设备信息、日志或截图。
- 请勿在仓库中提交任何账号凭据、Cookie、签名文件或私密密钥。
